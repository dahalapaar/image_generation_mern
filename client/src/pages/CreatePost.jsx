    ...
    const  generateImage = async () => {
        if(form.prompt ){
            try {
                ...
                const response = await fetch('http://localhost:8080/api/v1/apaar', {
                    method: 'POST',
  ...
  return (
    <section className="max-w-7xl mx-auto">
        <div>
            ...
            <p className='mt-2 text-[#66e75] text-[16px] max-w-[500px]'>Create 
            imaginative and visually stunning images through ApaarAI.</p>
        </div>
